...
void *_p_exports_Vector_ptr = duk_get_heapptr(ctx, -1);
...
duk_push_heap_stash(ctx);
duk_get_prop_string(ctx, -1, "SWIG");
duk_push_heapptr(ctx, _p_exports_Vector_ptr);
duk_set_prototype(ctx, -2);
duk_set_top(ctx, 0);
//void *_p_Vector_ptr;


SWIGTYPE_p_Vector->clientdata = _p_exports_Vector_ptr;
...
void *_p_exports_VectorArray_ptr = duk_get_heapptr(ctx, -1);
...
duk_push_heap_stash(ctx);
duk_get_prop_string(ctx, -1, "SWIG");
duk_push_heapptr(ctx, _p_exports_VectorArray_ptr);
duk_set_prototype(ctx, -2);
duk_set_top(ctx, 0);
//void *_p_VectorArray_ptr;


SWIGTYPE_p_VectorArray->clientdata = _p_exports_VectorArray_ptr;
