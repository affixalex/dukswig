...
static duk_ret_t _wrap_ivar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
...
static duk_ret_t _wrap_svar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  arg1 = (short)duk_to_number(ctx, value);
  svar = arg1;
...
static duk_ret_t _wrap_lvar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  arg1 = (long)duk_to_number(ctx, value);
  lvar = arg1;
...
static duk_ret_t _wrap_uivar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  SWIG_contract_assert((duk_to_number(ctx, value)>=0),"number must not be negative")
  arg1 = (unsigned int)duk_to_number(ctx, value);
  uivar = arg1;
...
static duk_ret_t _wrap_usvar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  SWIG_contract_assert((duk_to_number(ctx, value)>=0),"number must not be negative")
  arg1 = (unsigned short)duk_to_number(ctx, value);
  usvar = arg1;
...
static duk_ret_t _wrap_ulvar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  SWIG_contract_assert((duk_to_number(ctx, value)>=0),"number must not be negative")
  arg1 = (unsigned long)duk_to_number(ctx, value);
  ulvar = arg1;
...
static duk_ret_t _wrap_scvar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  arg1 = (signed char)duk_to_number(ctx, value);
  scvar = arg1;
...
static duk_ret_t _wrap_ucvar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  SWIG_contract_assert((duk_to_number(ctx, value)>=0),"number must not be negative")
  arg1 = (unsigned char)duk_to_number(ctx, value);
  ucvar = arg1;
...
static duk_ret_t _wrap_cvar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  arg1 = (duk_to_string(ctx, value))[0];
  cvar = arg1;
...
static duk_ret_t _wrap_fvar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  arg1 = (float)duk_to_number(ctx, value);
  fvar = arg1;
...
static duk_ret_t _wrap_dvar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
...
static duk_ret_t _wrap_strvar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  arg1 = (char *)duk_to_string(ctx, value);
  {
    delete [] strvar;
    if (arg1) {
...
static duk_ret_t _wrap_iptrvar_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,value,(void**)&arg1,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("iptrvar_set",1,SWIGTYPE_p_int);
  }
...
static duk_ret_t _wrap_name_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
...
static duk_ret_t _wrap_ptptr_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,value,(void**)&arg1,SWIGTYPE_p_Point,0))){
    SWIG_fail_ptr("ptptr_set",1,SWIGTYPE_p_Point);
  }
...
static duk_ret_t _wrap_pt_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,value,(void**)&argp1,SWIGTYPE_p_Point,0))){
    SWIG_fail_ptr("pt_set",1,SWIGTYPE_p_Point);
  }
  arg1 = *argp1;
...
static duk_ret_t _wrap_pt_get(duk_context *ctx)
{
  ...
  result = pt;
  {
    ...
    SWIG_NewPointerObj(ctx,(void *) resultptr,SWIGTYPE_p_Point,1); 
  }
...
static duk_ret_t _wrap_print_vars(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_print_vars. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
...
static duk_ret_t _wrap_new_int(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 1) {
    duk_push_string(ctx, "Illegal numargs for _wrap_new_int. Expected 1");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
...
static duk_ret_t _wrap_new_Point(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 2) {
    duk_push_string(ctx, "Illegal numargs for _wrap_new_Point. Expected 2");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
...
static duk_ret_t _wrap_Point_print(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 1) {
    duk_push_string(ctx, "Illegal numargs for _wrap_Point_print. Expected 1");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-0,(void**)&arg1,SWIGTYPE_p_Point,0))){
    SWIG_fail_ptr("Point_print",1,SWIGTYPE_p_Point);
  }
...
static duk_ret_t _wrap_pt_print(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_pt_print. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
...
static swig_duk_property exports_properties[] = {
  ...
  {
    "ivar", _wrap_ivar_get, _wrap_ivar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "svar", _wrap_svar_get, _wrap_svar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "lvar", _wrap_lvar_get, _wrap_lvar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "uivar", _wrap_uivar_get, _wrap_uivar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "usvar", _wrap_usvar_get, _wrap_usvar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "ulvar", _wrap_ulvar_get, _wrap_ulvar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "scvar", _wrap_scvar_get, _wrap_scvar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "ucvar", _wrap_ucvar_get, _wrap_ucvar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "cvar", _wrap_cvar_get, _wrap_cvar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "fvar", _wrap_fvar_get, _wrap_fvar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "dvar", _wrap_dvar_get, _wrap_dvar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "strvar", _wrap_strvar_get, _wrap_strvar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "cstrvar", _wrap_cstrvar_get, JS_veto_set_variable
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "iptrvar", _wrap_iptrvar_get, _wrap_iptrvar_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "name", _wrap_name_get, _wrap_name_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "ptptr", _wrap_ptptr_get, _wrap_ptptr_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "pt", _wrap_pt_get, _wrap_pt_set
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "status", _wrap_status_get, JS_veto_set_variable
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "path", _wrap_path_get, JS_veto_set_variable
  },
...
static duk_function_list_entry exports_functions[] = {
  ...
  {
    "print_vars", _wrap_print_vars, 0
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "new_int", _wrap_new_int, 1
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "new_Point", _wrap_new_Point, 2
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "Point_print", _wrap_Point_print, 1
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "pt_print", _wrap_pt_print, 0
  },
