...
#define SWIGTYPE_p_Foo__speed swig_types[0]
...
static duk_ret_t _wrap_Foo_set(duk_context *ctx)
{
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,value,(void**)&argp1,SWIGTYPE_p_class,0))){
    SWIG_fail_ptr("Foo_set",1,SWIGTYPE_p_class);
  }
  arg1 = *argp1;
...
static duk_ret_t _wrap_Foo_get(duk_context *ctx)
{
  ...
  result = Foo;
  {
    ...
    SWIG_NewPointerObj(ctx,(void *) resultptr,SWIGTYPE_p_class,1); 
  }
...
static duk_idx_t _wrap_enum_test(duk_context *ctx, duk_idx_t function, duk_idx_t thisObject, size_t argc)
{
  ...
  if(argc != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_enum_test.");
  
  arg1 = (color)(int)duk_to_number(ctx, argv[0]);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,argv[1],(void**)&argp2,SWIGTYPE_p_Foo__speed,0))){
    SWIG_fail_ptr("enum_test",2,SWIGTYPE_p_Foo__speed);
  }
  arg2 = *argp2;
...
static swig_type_info _swigt__p_Foo__speed = {"_p_Foo__speed", "Foo::speed *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_class = {"_p_class", "class *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_Foo__speed,
  &_swigt__p_class,
};

static swig_cast_info _swigc__p_Foo__speed[] = {  {&_swigt__p_Foo__speed, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_class[] = {  {&_swigt__p_class, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_Foo__speed,
  _swigc__p_class,
};
...
static duk_function_list_entry exports_functions[] = {
  ...
  {
    "enum_test", _wrap_enum_test, NULL
  },
...
// FIXME: Fix by convention in module loader
