...
static duk_ret_t _wrap_f__SWIG_0(duk_context *ctx)
{
...
static duk_ret_t _wrap_f__SWIG_1(duk_context *ctx)
{
  /* FRAGMENT: js_overloaded_function */
...
static duk_ret_t _wrap_f__SWIG_2(duk_context *ctx)
{
  /* FRAGMENT: js_overloaded_function */
...
static duk_ret_t _wrap_f__SWIG_3(duk_context *ctx)
{
  /* FRAGMENT: js_overloaded_function */
...
static duk_ret_t _wrap_f__SWIG_4(duk_context *ctx)
{
  /* FRAGMENT: js_overloaded_function */
...
static duk_ret_t _wrap_f__SWIG_5(duk_context *ctx)
{
  /* FRAGMENT: js_overloaded_function */
...
static duk_ret_t _wrap___wrap_f(duk_context *ctx)
{
  ...
  if(argc == 0) {
    res = _wrap_f__SWIG_0(ctx, function, thisObject, argc, &jsresult);
    if(res == SWIG_OK) {
  ...
  /* FRAGMENT: js_function_dispatch_case */
  if(argc == 1) {
    res = _wrap_f__SWIG_1(ctx, function, thisObject, argc, &jsresult);
    if(res == SWIG_OK) {
      *exception = 0; return jsresult; 
    }
  }
  ...
  /* FRAGMENT: js_function_dispatch_case */
  if(argc == 2) {
    res = _wrap_f__SWIG_2(ctx, function, thisObject, argc, &jsresult);
    if(res == SWIG_OK) {
      *exception = 0; return jsresult; 
    }
  }
  ...
  /* FRAGMENT: js_function_dispatch_case */
  if(argc == 1) {
    res = _wrap_f__SWIG_3(ctx, function, thisObject, argc, &jsresult);
    if(res == SWIG_OK) {
      *exception = 0; return jsresult; 
    }
  }
  ...
  /* FRAGMENT: js_function_dispatch_case */
  if(argc == 1) {
    res = _wrap_f__SWIG_4(ctx, function, thisObject, argc, &jsresult);
    if(res == SWIG_OK) {
      *exception = 0; return jsresult; 
    }
  }
  ...
  /* FRAGMENT: js_function_dispatch_case */
  if(argc == 1) {
    res = _wrap_f__SWIG_5(ctx, function, thisObject, argc, &jsresult);
    if(res == SWIG_OK) {
      *exception = 0; return jsresult; 
    }
  }
...
static duk_ret_t _wrap_f_double(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 1) {
    duk_push_string(ctx, "Illegal numargs for _wrap_f_double. Expected 1");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
