...
static duk_ret_t _wrap_add(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 3) {
    duk_push_string(ctx, "Illegal numargs for _wrap_add. Expected 3");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-0,(void**)&arg1,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("add",1,SWIGTYPE_p_int);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-1,(void**)&arg2,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("add",2,SWIGTYPE_p_int);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-2,(void**)&arg3,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("add",3,SWIGTYPE_p_int);
  }
...
static duk_ret_t _wrap_new_intp(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_new_intp. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
...
static duk_ret_t _wrap_copy_intp(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 1) {
    duk_push_string(ctx, "Illegal numargs for _wrap_copy_intp. Expected 1");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
...
static duk_ret_t _wrap_delete_intp(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 1) {
    duk_push_string(ctx, "Illegal numargs for _wrap_delete_intp. Expected 1");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-0,(void**)&arg1,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("delete_intp",1,SWIGTYPE_p_int);
  }
...
static duk_ret_t _wrap_intp_assign(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 2) {
    duk_push_string(ctx, "Illegal numargs for _wrap_intp_assign. Expected 2");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-0,(void**)&arg1,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("intp_assign",1,SWIGTYPE_p_int);
  }
...
static duk_ret_t _wrap_intp_value(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 1) {
    duk_push_string(ctx, "Illegal numargs for _wrap_intp_value. Expected 1");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-0,(void**)&arg1,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("intp_value",1,SWIGTYPE_p_int);
  }
...
static duk_ret_t _wrap_subtract(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 3) {
    duk_push_string(ctx, "Illegal numargs for _wrap_subtract. Expected 3");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-0,(void**)&arg1,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("subtract",1,SWIGTYPE_p_int);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-1,(void**)&arg2,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("subtract",2,SWIGTYPE_p_int);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-2,(void**)&arg3,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("subtract",3,SWIGTYPE_p_int);
  }
...
static duk_ret_t _wrap_divide(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 3) {
    duk_push_string(ctx, "Illegal numargs for _wrap_divide. Expected 3");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,-2,(void**)&arg3,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("divide",3,SWIGTYPE_p_int);
  }
...
static duk_function_list_entry exports_functions[] = {
  ...
  /* FRAGMENT: duk_function_declaration */
  {
    "new_intp", _wrap_new_intp, 0
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "copy_intp", _wrap_copy_intp, 1
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "delete_intp", _wrap_delete_intp, 1
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "intp_assign", _wrap_intp_assign, 2
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "intp_value", _wrap_intp_value, 1
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "subtract", _wrap_subtract, 3
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "divide", _wrap_divide, 3
  },
