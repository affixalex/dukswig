...
#define SWIGTYPE_p_MyWorld__Nested__Dweller swig_types[0]
#define SWIGTYPE_p_MyWorld__World swig_types[1]
...
static duk_ret_t _wrap_module_function(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_module_function. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
...
static duk_ret_t _wrap_module_variable_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
...
static duk_ret_t _wrap_module_variable_get(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
...
static duk_idx_t _wrap_new_MyWorld_World(duk_context *ctx)
{
  ...
  MyWorld::World *result;
  result = (MyWorld::World *)new MyWorld::World();
...
static duk_ret_t _wrap_MyWorld_World_create_world(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_MyWorld_World_create_world. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  MyWorld::World *arg1 = (MyWorld::World *) 0 ;
  int result;
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,thisObject,(void**)&arg1,SWIGTYPE_p_MyWorld__World,0))){
    SWIG_fail_ptr("MyWorld_World_create_world",1,SWIGTYPE_p_MyWorld__World);
  }
  
  result = (int)(arg1)->create_world();
  duk_push_number(ctx, (duk_double_t) result); 
...
static duk_ret_t _wrap_MyWorld_World_world_max_count_get(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
  /* The object must be on the top of the value stack on entry. */
  duk_push_this(ctx);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,thisObject,(void**)&arg1,SWIGTYPE_p_MyWorld__World,0))){
    SWIG_fail_ptr("MyWorld_World_world_max_count_get",1,SWIGTYPE_p_MyWorld__World);
  }
  
  result = (int)(int) ((arg1)->world_max_count);
  duk_push_number(ctx, (duk_double_t) result); 
...
static duk_ret_t _wrap_delete_MyWorld_World(duk_context *ctx)
{
  ...
  if(t) {
    if (t->own) {
      MyWorld::World * arg1 = (MyWorld::World *)t->data;
      delete arg1;
    }
...
static swig_duk_property _MyWorld_World_staticValues[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry _MyWorld_World_staticFunctions[] = {
  {
    NULL, NULL, 0 
  }
};

static swig_duk_property _MyWorld_World_properties[] = {
  /* FRAGMENT: duk_variable_declaration */
  {
    "world_max_count", _wrap_MyWorld_World_world_max_count_get, JS_veto_set_variable
  },
...
static duk_function_list_entry _MyWorld_World_functions[] = {
  /* FRAGMENT: duk_function_declaration */
  {
    "create_world", _wrap_MyWorld_World_create_world, 0
  },
...
static duk_ret_t _wrap_MyWorld_Nested_Dweller_MALE(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
  /* The object must be on the top of the value stack on entry. */
  duk_push_this(ctx);
  ...
  duk_push_number(ctx, (duk_double_t) MyWorld::Nested::Dweller::MALE); 
...
static duk_ret_t _wrap_MyWorld_Nested_Dweller_FEMALE(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
  /* The object must be on the top of the value stack on entry. */
  duk_push_this(ctx);
  ...
  duk_push_number(ctx, (duk_double_t) MyWorld::Nested::Dweller::FEMALE); 
...
static duk_ret_t _wrap_MyWorld_Nested_Dweller_count(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_MyWorld_Nested_Dweller_count. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  result = (int)MyWorld::Nested::Dweller::count();
  duk_push_number(ctx, (duk_double_t) result); 
...
static duk_idx_t _wrap_new_MyWorld_Nested_Dweller(duk_context *ctx)
{
  ...
  MyWorld::Nested::Dweller *result;
  result = (MyWorld::Nested::Dweller *)new MyWorld::Nested::Dweller();
...
static duk_ret_t _wrap_delete_MyWorld_Nested_Dweller(duk_context *ctx)
{
  /* FRAGMENT: js_dtoroverride */
  duk_push_this(ctx);
  duk_get_prop_string(ctx, -1, "\FFprivate");
  ...
  if(t) {
    if (t->own) {
      MyWorld::Nested::Dweller * arg1 = (MyWorld::Nested::Dweller *)t->data;
      delete arg1;
    }
    // remove the private data to make sure that it isn't accessed elsewhere
    duk_push_pointer(ctx, NULL);
...
/* FRAGMENT: duk_class_tables */
static swig_duk_property _MyWorld_Nested_Dweller_staticValues[] = {
  /* FRAGMENT: duk_variable_declaration */
  {
    "MALE", _wrap_MyWorld_Nested_Dweller_MALE, JS_veto_set_variable
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "FEMALE", _wrap_MyWorld_Nested_Dweller_FEMALE, JS_veto_set_variable
  },
...
static duk_function_list_entry _MyWorld_Nested_Dweller_staticFunctions[] = {
  /* FRAGMENT: duk_function_declaration */
  {
    "count", _wrap_MyWorld_Nested_Dweller_count, 0
  },
...
static swig_duk_property _MyWorld_Nested_Dweller_properties[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry _MyWorld_Nested_Dweller_functions[] = {
  {
    NULL, NULL, 0 
  }
};
...
static swig_type_info _swigt__p_MyWorld__Nested__Dweller = {"_p_MyWorld__Nested__Dweller", "p_MyWorld__Nested__Dweller", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_MyWorld__World = {"_p_MyWorld__World", "MyWorld::World *|p_MyWorld__World", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_MyWorld__Nested__Dweller,
  &_swigt__p_MyWorld__World,
};

static swig_cast_info _swigc__p_MyWorld__Nested__Dweller[] = {  {&_swigt__p_MyWorld__Nested__Dweller, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_MyWorld__World[] = {  {&_swigt__p_MyWorld__World, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_MyWorld__Nested__Dweller,
  _swigc__p_MyWorld__World,
};
...
static swig_duk_property MyWorld_properties[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry MyWorld_functions[] = {
  {
    NULL, NULL, 0 
  }
};
...
/* FRAGMENT: duk_nspace_declaration */
static swig_duk_property MyWorld_Nested_properties[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry MyWorld_Nested_functions[] = {
  {
    NULL, NULL, 0 
  }
};
...
static swig_duk_property exports_properties[] = {
  /* FRAGMENT: duk_variable_declaration */
  {
    "module_variable", _wrap_module_variable_get, _wrap_module_variable_set
  },
...
static duk_function_list_entry exports_functions[] = {
  /* FRAGMENT: duk_function_declaration */
  {
    "module_function", _wrap_module_function, 0
  },
