...
static duk_ret_t _wrap_delete_Shape(duk_context *ctx)
{
...
static duk_ret_t _wrap_Shape_x_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,thisObject,(void**)&arg1,SWIGTYPE_p_Shape,0))){
    SWIG_fail_ptr("Shape_x_set",1,SWIGTYPE_p_Shape);
  }
  
  arg2 = (double)duk_to_number(ctx, value);
  if (arg1) (arg1)->x = arg2;
...
static duk_ret_t _wrap_Shape_x_get(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
#ifdef SWIGRUNTIME_DEBUG
  printf("Called js_getter _wrap_Shape_x_get...\n");
#endif
...
static duk_ret_t _wrap_Shape_y_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
...
static duk_ret_t _wrap_Shape_y_get(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
#ifdef SWIGRUNTIME_DEBUG
  printf("Called js_getter _wrap_Shape_y_get...\n");
#endif
  /* The object must be on the top of the value stack on entry. */
...
static duk_ret_t _wrap_Shape_move(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 2) {
    duk_push_string(ctx, "Illegal numargs for _wrap_Shape_move. Expected 2");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  arg2 = (double)duk_to_number(ctx, -0);
...
static duk_ret_t _wrap_Shape_area(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_Shape_area. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
...
static duk_ret_t _wrap_Shape_perimeter(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_Shape_perimeter. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
...
static duk_ret_t _wrap_Shape_nshapes_set(duk_context *ctx)
{
  /* FRAGMENT: js_setter */
  /* The value must be on the stack top at entry. */
  duk_push_this(ctx);
  ...
  arg1 = (int)duk_to_number(ctx, value);
  Shape::nshapes = arg1;
...
static duk_ret_t _wrap_Shape_nshapes_get(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
#ifdef SWIGRUNTIME_DEBUG
  printf("Called js_getter _wrap_Shape_nshapes_get...\n");
#endif
  /* The object must be on the top of the value stack on entry. */
...
static swig_duk_property _exports_Shape_staticValues[] = {
...
static duk_function_list_entry _exports_Shape_staticFunctions[] = {
  {
    NULL, NULL, 0 
  }
};

static swig_duk_property _exports_Shape_properties[] = {
  /* FRAGMENT: duk_variable_declaration */
  {
...
static duk_function_list_entry _exports_Shape_functions[] = {
  /* FRAGMENT: duk_function_declaration */
  {
    "move", _wrap_Shape_move, 2
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "area", _wrap_Shape_area, 0
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "perimeter", _wrap_Shape_perimeter, 0
  },
...
static duk_ret_t _wrap_new_veto_Shape(duk_context *ctx)
{
  /* FRAGMENT: js_veto_ctor */
#ifdef SWIGRUNTIME_DEBUG
  if (SWIGTYPE_p_Shape != NULL ) {
    printf("Veto constructor for SWIGTYPE_p_Shape\n");
  }
#endif
...
static duk_idx_t _wrap_new_Circle(duk_context *ctx)
{
  /* FRAGMENT: js_ctor */
#ifdef SWIGRUNTIME_DEBUG
  printf("Called _wrap_new_Circle\n");
#endif
  if (duk_get_top(ctx) != 1) {
#ifdef SWIGRUNTIME_DEBUG
    printf("Illegal number of arguments for _wrap_new_Circle\n");
#endif
    duk_push_string(ctx, "Illegal number of arguments for _wrap_new_Circle.");
    duk_throw(ctx);
  }
  double arg1 ;
  Circle *result;
  ...
  SWIG_duk_NewPointerObj(ctx, result, SWIGTYPE_p_Circle, SWIG_POINTER_OWN);  
  duk_put_prop(ctx, -3);
...
static duk_ret_t _wrap_Circle_area(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_Circle_area. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,thisObject,(void**)&arg1,SWIGTYPE_p_Circle,0))){
...
static duk_ret_t _wrap_Circle_perimeter(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_Circle_perimeter. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
...
static duk_ret_t _wrap_delete_Circle(duk_context *ctx)
{
  /* FRAGMENT: js_dtoroverride */
  duk_push_this(ctx);
  duk_get_prop_string(ctx, -1, "\FFprivate");
...
/* FRAGMENT: duk_class_tables */
static swig_duk_property _exports_Circle_staticValues[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry _exports_Circle_staticFunctions[] = {
  {
    NULL, NULL, 0 
  }
};

static swig_duk_property _exports_Circle_properties[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry _exports_Circle_functions[] = {
  /* FRAGMENT: duk_function_declaration */
  {
    "area", _wrap_Circle_area, 0
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "perimeter", _wrap_Circle_perimeter, 0
  },
...
static duk_idx_t _wrap_new_Square(duk_context *ctx)
{
  /* FRAGMENT: js_ctor */
#ifdef SWIGRUNTIME_DEBUG
  printf("Called _wrap_new_Square\n");
#endif
  if (duk_get_top(ctx) != 1) {
#ifdef SWIGRUNTIME_DEBUG
    printf("Illegal number of arguments for _wrap_new_Square\n");
#endif
    duk_push_string(ctx, "Illegal number of arguments for _wrap_new_Square.");
    duk_throw(ctx);
  }
  double arg1 ;
  Square *result;
  ...
  duk_push_this(ctx);
  duk_push_string(ctx, "\FFprivate");
  SWIG_duk_NewPointerObj(ctx, result, SWIGTYPE_p_Square, SWIG_POINTER_OWN);  
  duk_put_prop(ctx, -3);
...
static duk_ret_t _wrap_Square_area(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_Square_area. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,thisObject,(void**)&arg1,SWIGTYPE_p_Square,0))){
...
static duk_ret_t _wrap_Square_perimeter(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_Square_perimeter. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
...
static duk_ret_t _wrap_delete_Square(duk_context *ctx)
{
  /* FRAGMENT: js_dtoroverride */
  duk_push_this(ctx);
  duk_get_prop_string(ctx, -1, "\FFprivate");
...
/* FRAGMENT: duk_class_tables */
static swig_duk_property _exports_Square_staticValues[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry _exports_Square_staticFunctions[] = {
  {
    NULL, NULL, 0 
  }
};

static swig_duk_property _exports_Square_properties[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry _exports_Square_functions[] = {
  /* FRAGMENT: duk_function_declaration */
  {
    "area", _wrap_Square_area, 0
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "perimeter", _wrap_Square_perimeter, 0
  },
...
/* Push constructor function; all Duktape/C functions are
	 ...
	 */
duk_push_c_function(ctx, _wrap_new_veto_Shape, DUK_VARARGS);
...
swig_duk_install_properties(ctx, -1, _exports_Shape_staticValues);
duk_put_function_list(ctx, -1, _exports_Shape_staticFunctions);
swig_duk_install_properties(ctx, -1, _exports_Shape_properties);
duk_put_function_list(ctx, -1, _exports_Shape_functions);
/* Install finalizer into the prototype */
duk_push_c_function(ctx, _wrap_delete_Shape, /*nargs*/ 0);
duk_set_finalizer(ctx, -2);
/* The stack is now [constructor, prototype (w/ finalizer)] */
/* Set the constructor prototype to the ancestor object. */
duk_set_prototype(ctx, -2);
/* Setup references. */  
void *_exports_Shape_ptr = duk_get_heapptr(ctx, -1);
SWIGTYPE_p_Shape->clientdata = _exports_Shape_ptr;


/* FRAGMENT: duk_class_registration */
duk_push_heapptr(ctx, exports_ptr);
duk_push_string(ctx, "Shape");
duk_push_heapptr(ctx, _exports_Shape_ptr);
...
/* Push constructor function; all Duktape/C functions are
	 * "constructable" and can be called as 'new Foo()'.
	 */
duk_push_c_function(ctx, _wrap_new_Circle, DUK_VARARGS);
/* Push MyObject.prototype object. */

/* FRAGMENT: duk_class_inherit */
/* Push the parent object to the value stack. */
if (SWIGTYPE_p_Shape != NULL) {
  duk_push_heapptr(ctx, SWIGTYPE_p_Shape->clientdata);
} else {
  duk_push_string(ctx, "Invalid class! _Shape");
  duk_throw(ctx);
}
...
/* The stack is now [constructor, prototype] */
/* Install methods and static properties */
swig_duk_install_properties(ctx, -1, _exports_Circle_staticValues);
duk_put_function_list(ctx, -1, _exports_Circle_staticFunctions);
swig_duk_install_properties(ctx, -1, _exports_Circle_properties);
duk_put_function_list(ctx, -1, _exports_Circle_functions);
/* Install finalizer into the prototype */
duk_push_c_function(ctx, _wrap_delete_Circle, /*nargs*/ 0);
duk_set_finalizer(ctx, -2);
/* The stack is now [constructor, prototype (w/ finalizer)] */
/* Set the constructor prototype to the ancestor object. */
duk_set_prototype(ctx, -2);
/* Setup references. */  
void *_exports_Circle_ptr = duk_get_heapptr(ctx, -1);
SWIGTYPE_p_Circle->clientdata = _exports_Circle_ptr;


/* FRAGMENT: duk_class_registration */
duk_push_heapptr(ctx, exports_ptr);
duk_push_string(ctx, "Circle");
duk_push_heapptr(ctx, _exports_Circle_ptr);
duk_put_prop(ctx, -3); /* Register class in the namespace */
...
/* Push constructor function; all Duktape/C functions are
	 * "constructable" and can be called as 'new Foo()'.
	 */
duk_push_c_function(ctx, _wrap_new_Square, DUK_VARARGS);
/* Push MyObject.prototype object. */
...
/* The stack is now [constructor, prototype] */
/* Install methods and static properties */
swig_duk_install_properties(ctx, -1, _exports_Square_staticValues);
duk_put_function_list(ctx, -1, _exports_Square_staticFunctions);
swig_duk_install_properties(ctx, -1, _exports_Square_properties);
duk_put_function_list(ctx, -1, _exports_Square_functions);
/* Install finalizer into the prototype */
duk_push_c_function(ctx, _wrap_delete_Square, /*nargs*/ 0);
duk_set_finalizer(ctx, -2);
/* The stack is now [constructor, prototype (w/ finalizer)] */
/* Set the constructor prototype to the ancestor object. */
duk_set_prototype(ctx, -2);
/* Setup references. */  
void *_exports_Square_ptr = duk_get_heapptr(ctx, -1);
SWIGTYPE_p_Square->clientdata = _exports_Square_ptr;


/* FRAGMENT: duk_class_registration */
duk_push_heapptr(ctx, exports_ptr);
duk_push_string(ctx, "Square");
duk_push_heapptr(ctx, _exports_Square_ptr);
duk_put_prop(ctx, -3); /* Register class in the namespace */
