...
static duk_ret_t _wrap_new_intSum__SWIG_0(duk_context *ctx)
{
  ...
  SWIG_duk_NewPointerObj(ctx, result, SWIGTYPE_p_SumT_int_t, SWIG_POINTER_OWN);
  /* FIXME */
  return 0;  
}


static duk_ret_t _wrap_new_intSum__SWIG_1(duk_context *ctx)
{
  /* FRAGMENT: js_overloaded_ctor */
  Sum< int > *result;
...
static duk_ret_t _wrap_intSum_call(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 1) {
    duk_push_string(ctx, "Illegal numargs for _wrap_intSum_call. Expected 1");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,thisObject,(void**)&arg1,SWIGTYPE_p_SumT_int_t,0))){
    SWIG_fail_ptr("intSum_call",1,SWIGTYPE_p_SumT_int_t);
  }
...
static duk_ret_t _wrap_intSum_result(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_intSum_result. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,thisObject,(void**)&arg1,SWIGTYPE_p_SumT_int_t,0))){
    SWIG_fail_ptr("intSum_result",1,SWIGTYPE_p_SumT_int_t);
  }
...
static duk_ret_t _wrap_delete_intSum(duk_context *ctx)
{
...
static swig_duk_property _exports_intSum_staticValues[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry _exports_intSum_staticFunctions[] = {
  {
    NULL, NULL, 0 
  }
};

static swig_duk_property _exports_intSum_properties[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry _exports_intSum_functions[] = {
  /* FRAGMENT: duk_function_declaration */
  {
    "call", _wrap_intSum_call, 1
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "result", _wrap_intSum_result, 0
  },
...
static duk_ret_t _wrap_new_doubleSum__SWIG_0(duk_context *ctx)
{
  /* FRAGMENT: js_overloaded_ctor */
  double arg1 ;
  Sum< double > *result;
  ...
  SWIG_duk_NewPointerObj(ctx, result, SWIGTYPE_p_SumT_double_t, SWIG_POINTER_OWN);
  /* FIXME */
  return 0;  
}


static duk_ret_t _wrap_new_doubleSum__SWIG_1(duk_context *ctx)
{
  /* FRAGMENT: js_overloaded_ctor */
  Sum< double > *result;
...
static duk_idx_t _wrap_new_doubleSum(duk_context *ctx)
{
  ...
  /* FIXME */
  if(duk_get_top(ctx) == 1) {
    _wrap_new_doubleSum__SWIG_0(ctx);
    //FIXME
    //if(thisObject != NULL) { *exception=0; return thisObject; } /* reset exception and return */
  }
  ...
  /* FIXME */
  if(duk_get_top(ctx) == 0) {
    _wrap_new_doubleSum__SWIG_1(ctx);
    //FIXME
    //if(thisObject != NULL) { *exception=0; return thisObject; } /* reset exception and return */
  }
...
static duk_ret_t _wrap_doubleSum_call(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 1) {
    duk_push_string(ctx, "Illegal numargs for _wrap_doubleSum_call. Expected 1");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,thisObject,(void**)&arg1,SWIGTYPE_p_SumT_double_t,0))){
    SWIG_fail_ptr("doubleSum_call",1,SWIGTYPE_p_SumT_double_t);
  }
...
static duk_ret_t _wrap_doubleSum_result(duk_context *ctx)
{
  /* FRAGMENT: js_function */
  if (duk_get_top(ctx) != 0) {
    duk_push_string(ctx, "Illegal numargs for _wrap_doubleSum_result. Expected 0");
    duk_throw(ctx);
  }
  duk_push_this(ctx);
  void *thisObject = duk_get_heapptr(ctx, -1);
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(ctx,thisObject,(void**)&arg1,SWIGTYPE_p_SumT_double_t,0))){
    SWIG_fail_ptr("doubleSum_result",1,SWIGTYPE_p_SumT_double_t);
  }
...
static duk_ret_t _wrap_delete_doubleSum(duk_context *ctx)
{
  /* FRAGMENT: js_dtoroverride */
  duk_push_this(ctx);
  duk_get_prop_string(ctx, -1, "\FFprivate");
...
/* FRAGMENT: duk_class_tables */
static swig_duk_property _exports_doubleSum_staticValues[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry _exports_doubleSum_staticFunctions[] = {
  {
    NULL, NULL, 0 
  }
};

static swig_duk_property _exports_doubleSum_properties[] = {
  {
    NULL, NULL, NULL 
  }
};

static duk_function_list_entry _exports_doubleSum_functions[] = {
  /* FRAGMENT: duk_function_declaration */
  {
    "call", _wrap_doubleSum_call, 1
  },
  
  
  /* FRAGMENT: duk_function_declaration */
  {
    "result", _wrap_doubleSum_result, 0
  },
...
static swig_type_info _swigt__p_SumT_double_t = {"_p_SumT_double_t", "p_SumT_double_t|Sum< double > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_SumT_int_t = {"_p_SumT_int_t", "p_SumT_int_t|Sum< int > *", 0, 0, (void*)0, 0};
