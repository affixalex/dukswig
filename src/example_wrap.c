...
static duk_ret_t _wrap_ICONST(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
  ...
  duk_push_number(ctx, (duk_double_t) 42); 
...
static duk_ret_t _wrap_CCONST(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
  /* The object must be on the top of the value stack on entry. */
  duk_push_this(ctx);
...
static duk_ret_t _wrap_CCONST2(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
  /* The object must be on the top of the value stack on entry. */
  duk_push_this(ctx);
...
static duk_ret_t _wrap_SCONST(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
  /* The object must be on the top of the value stack on entry. */
  duk_push_this(ctx);
  ...
  duk_push_string(ctx,(const char *)"Hello World"); 
...
static duk_ret_t _wrap_SCONST2(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
  /* The object must be on the top of the value stack on entry. */
  duk_push_this(ctx);
...
static duk_ret_t _wrap_EXPR(duk_context *ctx)
{
  /* FRAGMENT: js_getter */
  /* The object must be on the top of the value stack on entry. */
  duk_push_this(ctx);
  ...
  duk_push_number(ctx, (duk_double_t) 42+3*(2.1828)); 
...
static duk_ret_t _wrap_iconst(duk_context *ctx)
{
  ...
  duk_push_number(ctx, (duk_double_t) 37); 
...
static duk_ret_t _wrap_fconst(duk_context *ctx)
{
  ...
  duk_push_number(ctx, (duk_double_t) 3.14); 
...
static swig_duk_property exports_properties[] = {
  ...
  {
    "ICONST", _wrap_ICONST, JS_veto_set_variable
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "FCONST", _wrap_FCONST, JS_veto_set_variable
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "CCONST", _wrap_CCONST, JS_veto_set_variable
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "CCONST2", _wrap_CCONST2, JS_veto_set_variable
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "SCONST", _wrap_SCONST, JS_veto_set_variable
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "SCONST2", _wrap_SCONST2, JS_veto_set_variable
  },
  
  
  /* FRAGMENT: duk_variable_declaration */
  {
    "EXPR", _wrap_EXPR, JS_veto_set_variable
  },
...
/* This fragment is currently unused with Duktape. */
